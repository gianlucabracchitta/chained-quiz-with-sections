...
Description: Create a chained quiz with sections for Laura where the upcoming questions can depend on the previous answer
Author: Kiboko Labs customized for doloveyourself.com by Gianluca Bracchitta
Version: 0.0.1
...
require_once(CHAINED_PATH.'/models/section.php');
...
//sections added 
require_once(CHAINED_PATH.'/controllers/sections.php');
//
