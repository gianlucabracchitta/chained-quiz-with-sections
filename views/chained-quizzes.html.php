<div class="wrap">
	<h1><?php _e('Laura\'s Chained Quizzes', 'chained')?></h1>
	...
	<table class="widefat">
		<tr>
			<th><?php _e('Quiz title', 'chained')?></th>
			<th><?php _e('Quiz Shortcode', 'chained')?></th>
			<th><?php _e('Sections', 'chained')?></th>
			<th><?php _e('Questions', 'chained')?></th>
			<th><?php _e('Results', 'chained')?></th>
			<th><?php _e('Submitted by', 'chained')?></th>
		...
		<?php foreach($quizzes as $quiz):
			...
			<tr class="<?php echo $class?>">
				...
				<td><input type="text" size="12" value="[chained-quiz <?php echo $quiz->id?>]" readonly onclick="this.select();"></td>
			<td><a href="admin.php?page=chainedquiz_sections&quiz_id=<?php echo $quiz->id?>"><?php _e('Manage', 'chained')?></a></td>
